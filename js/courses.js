...
// на занятии; см. js/labs.js, tools/lab_encrypt.py). pass — порог зачёта: следующая
// лаба открывается студенту только после зачёта по предыдущей.
window.CFD_LABS = {
  nm: [
    { id: 'w01', title: 'Лаба 1 · Точное суммирование и катастрофа вычитания', href: 'nm/w01-lab.html', total: 18, pass: 16 },
    { id: 'w02', title: 'Лаба 2 · Ряды Тейлора: точность, сходимость, знакопеременность', href: 'nm/w02-lab.html', total: 11, pass: 9 },
    { id: 'w03', title: 'Лаба 3 · Полиномиальная интерполяция и феномен Рунге', href: 'nm/w03-lab.html', total: 14, pass: 12 },
    { id: 'w04', title: 'Лаба 4 · Чебышёвские узлы и кубический сплайн', href: 'nm/w04-lab.html', total: 9, pass: 7 },
