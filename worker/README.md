...
Кто и когда шлёт:
- страница лабы (`js/labs.js`, `CFDLabs.saveProgress`) — когда впервые
  пройдена ещё одна задача, либо код менялся и с прошлой отправки прошло
  больше 5 минут; ошибки глушатся, на студента не влияют;
